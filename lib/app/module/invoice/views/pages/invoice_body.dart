...
class InvoiceBody extends StatelessWidget {
        ...
        child: Column(
          children: [
            ...
            Column(
              ...
              (index) => Column(
                children: [
                  invoiceItem(demoData[index]["quantity"],
                      demoData[index]["price"], demoData[index]["itemDesc"]),
                  SizedBox(
            ...
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                  primary: secondaryColor, onPrimary: Colors.white70),
              child: SizedBox(
  ...
  Container invoiceItem(int quantity, int price, String itemDesc) {
